...
import data from '@/assets/json/f_data.json'
...
const { serviceMap, getServiceListByMart } = useServiceList('familymart')
...
onMounted(() => {
  ...
  html?.setAttribute('theme', 'familymart')
    ...
    <div class="nav-main-container">
      <div class="nav-container">
        ...
        <button 
          ...
          @click="router.push({ name: '7-11', params: { ...route.params }, query: { zoom: route.query.zoom } })"
        >
          7-11
